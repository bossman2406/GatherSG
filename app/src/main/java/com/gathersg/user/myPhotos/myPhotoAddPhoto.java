...
import com.gathersg.user.addevent.eventOrganiserAdd;
...
public class myPhotoAddPhoto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addDetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), myPhotoAdd.class);
                intent.putExtra("imageData", imageData);
                startActivity(intent);
                finish();
            }
        });
        dialog = new Dialog(myPhotoAddPhoto.this);
        ...
        selectImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                takePhoto.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (ContextCompat.checkSelfPermission(myPhotoAddPhoto.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                            // Permission is not granted, request it
                            ActivityCompat.requestPermissions(myPhotoAddPhoto.this, new String[]{Manifest.permission.CAMERA}, MY_CAMERA_PERMISSION_REQUEST);
                        } else {
