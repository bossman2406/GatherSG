...
import com.gathersg.user.register.Register;
...
public class Login extends AppCompatActivity {
    ...
    private com.gathersg.user.login.volunteerLogin volunteerLogin;
    private com.gathersg.user.login.organiserLogin organiserLogin;
