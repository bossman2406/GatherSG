...
public class eventStatusService {
    ...
    private static void updateEventDetails(DocumentReference eventRef, String uid, String eventName, Context context, View view) {
        eventRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            @Override
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
    ...
    private static void updateVolunteerEvents(String uid, String eventName, String eventDesc, String date, String organiser, String locName, Double lat, Double lon, Blob image, String status, Context context, View view) {
        FirebaseFirestore db = FirebaseFirestore.getInstance();
